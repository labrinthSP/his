        ...
        <>
            <div className="min-h-screen flex items-center justify-center">
                <div className="border border-[#6d6d6d] p-8 rounded shadow-md max-w-md w-full">
                    <h2 className="text-2xl mb-4 font-bold text-center">Nurses Station</h2>
                    <form onSubmit={onSubmit}>
                        <div className="mb-4">
                            <label htmlFor="name" className="block mb-1 font-semibold">
                                Access ID
                            </label>
                            <input type="name" name="name" value={name} onChange={onChange} placeholder="Enter ID" className="w-full border border-[#626262] rounded px-3 py-2" />
                        </div>
                        <div className="mb-4">
