...
const DoctorPatientRegister = () => {
    ...
    const { name, address, number, email, dob, gender, contact, relation, phone, provider, policy, doctorNotes } = formData;
...
export default DoctorPatientRegister;
